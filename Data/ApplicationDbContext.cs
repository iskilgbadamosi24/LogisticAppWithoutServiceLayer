...
namespace Shipping_System.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Branch>().HasData(new Branch { Id = 1, Name = "Cairo", CreationDate = DateTime.Now, IsDeleted = false });
            ...
            builder.Entity<Country>().Property(m => m.IsDeleted).HasDefaultValue(false);
            ...
            builder.Entity<Country>().HasData(new Country { Id = 10, Name = "Egypt", });
            ...
            builder.Entity<PaymentMethod>().HasData(new PaymentMethod { Id = 2, Name = "Transfer" });
