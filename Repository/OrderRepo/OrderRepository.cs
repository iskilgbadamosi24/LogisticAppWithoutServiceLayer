...
namespace Shipping_System.Repository.OrderRepo
{
    public class OrderRepository : IOrderRepository
    {
        ...
        public decimal CalculateTotalPrice(Order order)
        {
            ...
            Price += CalculatePriceIfShippingToHomeAddress(order);  //Shipping To HomeAddress Price
        ...
        public decimal CalculatePriceIfShippingToHomeAddress(Order order)
        {
            decimal shippingToHomeAddressPrice;

            if (order.DeliverToHomeAddress == true)
            {
                shippingToHomeAddressPrice = 30;
            }
            else
            {
                shippingToHomeAddressPrice = 0;
            }
            return shippingToHomeAddressPrice;
        }
        ...
        {
            return _context.Orders.Where(o => o.OrderStateId == stateId && o.IsDeleted == false)/*.Include(o=>o.ClientCity).Include(o=>o.ClientCountry)*/.ToList();
        }
