...
namespace Shipping_System.Controllers
{
    public class OrderController : Controller
    {
        ...
        ICountryRepository _ghostRepository;
            ...
            )
        {
            ...
            _ghostRepository = countryRepository;
        ...
        List<Order> orders ;
            ...
            foreach (var item in orders)
            {
                ...
                Country country = _ghostRepository.GetById(item.ClientCountryId);
                ...
                ordersViewModelItem.PhoneNumber = item.ClientPhone;
                ordersViewModelItem.City = city.Name;
                ordersViewModelItem.Country = country.Name;
        ...
        public IActionResult Create()
        {
            ...
            ViewData["Countries"] = _ghostRepository.GetAll();
        ...
        //public IActionResult getCitesByCountry(int countrId)  // Get order by country
        //{
        //    List<City> cities = _cityRepository.GetAllCitiesByCountryId(countrId);
        //    return Json(cities);
        //}
        ...
        public IActionResult Edit(int id)
        {
            ...
            ViewData["City"] = _cityRepository.GetAll().Where(c=>c.CountrId==order.ClientCountryId).ToList();
        ...
        public async Task<IActionResult> Status(int id)
        {
            ...
            List<RepresentativeCountryBranchPercentageViewModel> viewmodels = new List<RepresentativeCountryBranchPercentageViewModel>();

            foreach (var item in representativesInSameCity)
            {
                var user =await _userManager.FindByIdAsync(item.AppUserId);

                RepresentativeCountryBranchPercentageViewModel viewmodel = new RepresentativeCountryBranchPercentageViewModel()
                {
                    AppUserId = user.Id,
                    Name = user.Name,
                };
        ...
        public IActionResult OrderReport(string startDate, string endDate, int statusId)
        {
            ...
            foreach (var item in orders)
            {
                ...
                ordersViewModelItem.Client = item.ClientName;
                ordersViewModelItem.PhoneNumber = item.ClientPhone;
                ordersViewModelItem.Country = item.ClientCountry.Name;
