...
namespace Shipping_System.Controllers
{
    public class RepresentativesController : Controller
    {
        ...
        {
            var repViewModel = new RepresentativeCountryBranchPercentageViewModel
            {
        ...
        [Authorize(Permissions.Users.Create)]
        [HttpPost]
        public async Task<IActionResult> Create(RepresentativeCountryBranchPercentageViewModel repViewModel)
        {
            repViewModel.Countries = _countryRepository.GetAll();
            ...
            var rep = new Representative
            {
                ...
                CountryId = repViewModel.CountryId,
                BranchId = repViewModel.BranchId,
        ...
        [Authorize(Permissions.Users.Edit)]
        [HttpPost]
        public async Task<IActionResult> Edit(RepresentativeCountryBranchPercentageViewModel repViewModel)
        {
            ...
            repFDB.CountryId = repViewModel.CountryId;
